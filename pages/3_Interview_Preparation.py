...
st.sidebar.write(f"**Practiced:** {practiced_count} / {total_q}")
st.sidebar.progress(min(practiced_count / total_q if total_q > 0 else 0, 1.0))
st.sidebar.write(f"**Saved:** {saved_count}")
